...
- [Customizing Package Build Options](https://support.rstudio.com/hc/en-us/articles/200486518-Customizing-Package-Build-Options-in-the-RStudio-IDE)
...
1. Learn how to make unit tests in section \@ref(pkg-tests) and do that for your new function `select2`. Which silly cases you should test? Here, you can use `usethis::use_package("dplyr", type = "Suggests")` to add package {dplyr} to the suggested packages (because you will use this package in tests only).
...
See [this chapter](https://r-pkgs.org/Metadata.html#sec-description).
...
If you want to understand what's going on, read [this chapter](https://r-pkgs.org/Metadata.html#sec-namespace).
...
Learn more with [this chapter](https://r-pkgs.org/testing-basics.html).
