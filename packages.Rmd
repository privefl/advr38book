...
3. on GitHub, go to the settings of your repo, and enable GitHub Pages using the master branch /docs/ folder. This will render everything that you have in this folder as a website. 

4. run `pkgdown:::build_site()`

4. push your changes and see check the website (after 1-2 minutes)
