...
```{r, include=FALSE}
WORDS_TO_IGNORE <- c("overbrace", "underbrace", "Kausal", "Kaluarachchi", "geq", "logi", "typeof", "vec")
...
Two-dimensional matrices and multi-dimensional arrays are obtained with the dimensions attribute
