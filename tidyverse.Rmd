...
For learning how to do data analysis from importing data and tidying it to analyzing it and reporting results, we will use [book R for Data Science](http://r4ds.had.co.nz/). You can find most of the solutions to the exercises [there](https://jrnold.github.io/r4ds-exercise-solutions/).
